// GuiJi_kaxiaoshou.cpp : implementation file
//
...
GuiJi_kaxiaoshou::GuiJi_kaxiaoshou(CWnd* pParent /*=NULL*/)
	: CDialog(GuiJi_kaxiaoshou::IDD, pParent)
{
	//{{AFX_DATA_INIT(GuiJi_kaxiaoshou)
		// NOTE: the ClassWizard will add member initialization here
	//}}AFX_DATA_INIT
}


void GuiJi_kaxiaoshou::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(GuiJi_kaxiaoshou)
...
BEGIN_MESSAGE_MAP(GuiJi_kaxiaoshou, CDialog)
	//{{AFX_MSG_MAP(GuiJi_kaxiaoshou)
	ON_BN_CLICKED(IDC_BUTTON2, OnSelect)
	ON_BN_CLICKED(IDC_BUTTON3, OnOutPutExcel)
	ON_BN_CLICKED(IDC_BUTTON4, OnOutPutTXT)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// GuiJi_kaxiaoshou message handlers

BOOL GuiJi_kaxiaoshou::OnInitDialog() 
{
...
void GuiJi_kaxiaoshou::OnSelect() 
{
	// TODO: Add your control notification handler code here
	CString select_city,select_product;
	...
	try
	{
		...
		m_AdoConn.OnInitADOConn();
		sql="select * from card_sale where my_date between '"+start_Date+"' and '"+end_Date+"' AND my_check_state=1 ";//sql语句
...
void GuiJi_kaxiaoshou::OnOutPutExcel() 
{
	// TODO: Add your control notification handler code here
		ExportListToExcel(&m_listctrl,"卡销售账单");
}

void GuiJi_kaxiaoshou::OnOutPutTXT() 
{
	// TODO: Add your control notification handler code here
